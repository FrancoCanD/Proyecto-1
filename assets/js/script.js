...
const cambiarMensajeBtn = document.getElementById('changeTextBtn');

cambiarMensajeBtn.addEventListener('click', function() {
    mensajeElemento.textContent = 'El mensaje ha sido cambiado por JavaScript';
    mensajeElemento.style.color = 'green';
    mensajeElemento.style.fontSize = '20px';

    cambiarMensajeBtn.textContent = 'Mensaje Cambiado';
    cambiarMensajeBtn.disabled = true;
});